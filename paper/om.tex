...
always backtrace this orthotree. Unions are allowed only between orthotopes
...
\begin{itemize}
  ...
  \item a function that loads from such savepoints
\end{itemize}
...
$n$-dimensianal OM only deals with $n$-dimensional orthotopes and
0-dimensional orthotopes. 0-dimensional orthomopes are just variables.

See also \url{http://paraiso-lang.org/wiki/index.php/VVM} for VVM instruction
set plan, an ancestor of OM.

For this and next section, let us denote {\tt n}-dimensianal Orthotope of
...
information on generating arithmetic operations for various hardwaer in
pluggable manner.
